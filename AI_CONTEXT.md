...
- `AdminAuditLog` (journal append-only des actions admin critiques : `action`, `resourceType`, `resourceId`, `metadata`, `ipAddress`, `userAgent`, `createdAt`)
