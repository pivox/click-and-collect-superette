...
Correcter ma liste avant validation.
...
Le backend actuel implèmente un modèle mono-Kadhia par supérette (`/me/stores/{storeId}/kadhia`). La migration vers le modèle multi-Kadhia requiert :
