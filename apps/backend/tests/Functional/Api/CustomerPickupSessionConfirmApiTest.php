...
final class CustomerPickupSessionConfirmApiTest extends FunctionalApiTestCase
{
    ...
    /**
     * Once the QR has been scanned and the order is pickup_pending, an expired session
     * TTL must not block the confirmation. Expiry guards the scan step only.
     */
    public function testExpiredSessionAfterScanCanStillBeConfirmed(): void
    {
