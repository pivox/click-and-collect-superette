  ...
  return (
    <div>
      ...
      {selectedTab === 'active' && error && (
        <div role="alert" aria-atomic="true" className="mt-4 rounded-md bg-status-cancel-bg px-4 py-3 text-sm text-status-cancel">
          {error}
        </div>
      )}
      ...
      {selectedTab === 'history' && (
        <section id="panel-history-orders" role="tabpanel" className="mt-5 rounded-md bg-card shadow-card">
          ...
          {historyError && (
            <div role="alert" aria-atomic="true" className="m-4 flex flex-wrap items-center justify-between gap-3 rounded-md bg-status-cancel-bg px-4 py-3 text-sm text-status-cancel">
