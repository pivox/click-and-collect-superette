  ...
  if (!draft) {
    return (
      <div className="flex min-h-40 items-center justify-center">
        {loadError ? (
          <p role="alert" aria-atomic="true" className="text-sm text-red-600">{loadError}</p>
        ) : (
  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4 rounded-lg border border-line bg-card p-4">
        ...
        {saveError && <p role="alert" aria-atomic="true" className="text-sm text-red-600">{saveError}</p>}
